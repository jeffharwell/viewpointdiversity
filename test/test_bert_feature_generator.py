...
from viewpointdiversitydetection import BertFeatureGenerator, FeatureVectorsAndTargets
from viewpointdiversitydetection import TokenFilter, ParsedDocumentsFourForums, FindCharacteristicKeywords


class BertFeatureGeneratorTest(unittest.TestCase):
    ...
    def test_avg_vector_no_divide_by_zero(self):
        ...
        :return:
        """
        w2v_obj = BertFeatureGenerator(False, False, False)
